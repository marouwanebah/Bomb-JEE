...
public   class InfoAgent {
	...
	private static int  compteurIdentifant =0; 
	private int _identifiantAgent; 
	...
	public InfoAgent(int x, int y, AgentAction agentAction, char type, ColorAgent color, boolean isInvincible, boolean isSick) {
		...
		this._identifiantAgent=compteurIdentifant; 
		++compteurIdentifant;
	}
	...
	public int get_identifiantAgent() {
		return _identifiantAgent;
	}

	public void set_identifiantAgent(int _identifiantAgent) {
		this._identifiantAgent = _identifiantAgent;
	}
